...
Page({
  ...
  view: function (e) {
    ...
    wx.navigateTo
      ({
        url: '/pages/activity/activityMess?Aname=' + e.currentTarget.dataset.name + '&Adeadline=' + e.currentTarget.dataset.deadline + '&Ano=' + e.currentTarget.dataset.ano+'&flag=history',
        success: function () {
          console.log('done')
        }
      })
